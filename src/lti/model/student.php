 ...
 */
  function getAccessScheduleNotify() {
      ...
      $schedule_id = create_schedule_participant($schedule_name, $this->assessment_id, $this->participant_id, TRUE, $schedule_starts, $schedule_stops, $this->group_id, $this->group_id, TRUE, FALSE, 0, FALSE, FALSE, 0, FALSE, 0);
