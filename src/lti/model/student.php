 ...
 */
  function getAccessScheduleNotify() {
      ...
      $schedule_starts = $schedule_starts->format('Y-m-dTH:i:s');
      $schedule_stops = $schedule_stops->format('Y-m-dTH:i:s');
      $schedule_id = create_schedule_participant($schedule_name, $this->assessment_id, $this->participant_id, 1, $schedule_starts, $schedule_stops, 1);
