 ...
 */
  function getAccessScheduleNotify() {
      ...
      $schedule_id = create_schedule_participant(0, $schedule_name, $this->assessment_id, $this->participant_id, 1, $schedule_starts, $schedule_stops, $this->group_id, $this->group_id, 1, 0, 0, 0, 0, 0, 0, 0, 0);
